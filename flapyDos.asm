...
AplicarGravedad PROC
    ...
    CMP contadorGravedad, 15  ; Aplicar gravedad cada 15 iteraciones
...
LimpiarPantalla PROC
    MOV AH, 06H
    MOV AL, 00H
    MOV BH, 3Eh ; Fondo verde (2), texto amarillo (E)
    MOV CH, 00H
    MOV CL, 00H
    MOV DH, 18H
    MOV DL, 4FH
...
DibujarUnObstaculo PROC
    ...
    ADD CH, 7    ; Ajustar para que sea dos filas después del hueco
    MOV CL, BL   ; Columna superior izquierda
